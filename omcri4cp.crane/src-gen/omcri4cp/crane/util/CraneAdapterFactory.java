 ...
 * @generated
 */
public class CraneAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static CranePackage modelPackage;
	 ...
	 * @generated
	 */
	public CraneAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = CranePackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected CraneSwitch<Adapter> modelSwitch =
		new CraneSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseGripper(Gripper object) {
				return createGripperAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link omcri4cp.crane.Crane <em>Crane</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link omcri4cp.crane.Motion <em>Motion</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link omcri4cp.crane.Gripper <em>Gripper</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

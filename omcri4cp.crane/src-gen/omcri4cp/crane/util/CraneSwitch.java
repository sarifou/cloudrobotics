 ...
 * @generated
 */
public class CraneSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CranePackage.CRANE: {
				...
				if (result == null) result = caseResource(crane);
			...
			case CranePackage.MOTION: {
				...
				if (result == null) result = caseMixinBase(motion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CranePackage.GRIPPER: {
				Gripper gripper = (Gripper)theEObject;
				T result = caseGripper(gripper);
				if (result == null) result = caseMixinBase(gripper);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Gripper</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Gripper</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGripper(Gripper object) {
		return null;
	}

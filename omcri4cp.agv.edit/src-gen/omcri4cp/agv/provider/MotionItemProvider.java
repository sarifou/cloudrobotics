...
/**
 * This is the item provider adapter for a {@link omcri4cp.agv.Motion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MotionItemProvider extends MixinBaseItemProvider {
	/**
	...
	protected void addAnglePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Motion_angle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Motion_angle_feature", "_UI_Motion_type"),
				 AgvPackage.Literals.MOTION__ANGLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
